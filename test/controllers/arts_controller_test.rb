...
class ArtsControllerTest < ActionController::TestCase
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post :create, art: { cat_id: @art.cat_id, description: @art.description, title: @art.title, user_id: @art.user_id }
    end
  ...
  test "should update art" do
    patch :update, id: @art, art: { cat_id: @art.cat_id, description: @art.description, title: @art.title, user_id: @art.user_id }
    assert_redirected_to art_path(assigns(:art))
  end
